...
class User extends OAuthUser implements AdvancedUserInterface, \Serializable {
	 ...
	 * 			max = 20,
	 *			min = 2,
	 *			minMessage = "Benutzername muss mindestens {{ limit }} Symbolen sein",
	 *			maxMessage = "Benutzername muss maximal {{ limit }} Symbolen sein"
	 * 		)
	 */
	protected $username;
	 ...
	 *
	 * @ORM\Column(type="string", length=128, nullable=true, options={"default":""})
	 */
	protected $reset;
	...
	/**
	 * @ORM\Column(type="string", length=20,nullable=true)
	 * TEMPORARY IS USED; IF USER GAVE A FEEDBACK 
	 */
	protected $tel3;
	...
	/**
	 * 1 - is activated
	 * 5 - is activated temporary (for 48 Hours)
	 *
	 * @return boolean
	 */
	public function isEnabled() {
		return $this->status == 1 || $this->status == 5; // && (time()-(60*60*48)) < $this->getCreated();
	}
...
// 		return $this->userroles->matching($criteria);
	...
	public function getNoti1() {
		return $this->noti1;
	}
	public function setNoti1($noti1) {
		$this->noti1 = $noti1;
		return $this;
	}
	public function getNoti2() {
		return $this->noti2;
	}
	public function setNoti2($noti2) {
		$this->noti2 = $noti2;
		return $this;
	}
